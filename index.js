...
function calculateExpression(expression) {
     ...
     "string" ? eval(expression) : "Argument is not a string";
...
function getNumberFromString(s) {
  ...
  // повертаємо це не є числом ? да . нє
...
function getIntegerFromString(s) {
  let n = parseInt(s)
  return isNaN(n) ? "Couldn't extract an integer from the provided string." : n ;
